...
import lunch2Desk_pages.OrderCompleted;
import lunch2Desk_pages.SellerLogin;

public class TC03_OrderCompletedTest extends TestBase {
	...
	public void orderCompletedTest(String uname, String password, String Runmode) throws Exception {
