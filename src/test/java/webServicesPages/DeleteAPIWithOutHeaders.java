...
public class DeleteAPIWithOutHeaders extends TestBase {
	
public  static void deleteAPIWithOutHeaders(String apiURL , String StatusCode) throws JsonGenerationException, JsonMappingException, IOException{
