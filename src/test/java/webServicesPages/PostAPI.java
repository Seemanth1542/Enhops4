...
public class PostAPI extends TestBase{
	...
	public  static void postAPITest(String apiURL, String StatusCode ) throws JsonGenerationException, JsonMappingException, IOException{
		...
		closebaleHttpResponse = post(url, usersJsonString, headerMap); //call the API
		...
		test.log(LogStatus.INFO,  "Created At " +usersResObj.getCreatedAt() );
		log.info("Created At " +usersResObj.getCreatedAt());
